...
//Cabeçalho da página
    public function Header() {
        ...
        if ($this->page == 1) {
            $img_grupoboavida = K_PATH_IMAGES . 'logo.png';
            $img_helpdesk = K_PATH_IMAGES . 'logo.png';
            $img_marca_agua = K_PATH_IMAGES . 'quote.png';
    ...
    public function imprimirVeiculos($cabecalho, $dados) {
        $this->Ln(50);
        ...
        foreach ($dados as $obj) {
            ...
            $this->Cell($cabecalho[0][1], 6, $cont, 1, 0, 'L', $fill);
            $this->Cell($cabecalho[1][1], 6, $obj->getMarca(), 1, 0, 'L', $fill);
            $this->Cell($cabecalho[2][1], 6, $obj->getModelo(), 1, 0, 'L', $fill);
            $this->Cell($cabecalho[3][1], 6, $obj->getCor(), 1, 0, 'L', $fill);
...
EOD;
    ...
    public function imprimirTabelaCandidatos($cabecalho, $dados) {
    ...
    public function imprimirTabelaFuncoes($cabecalho, $dados) {
