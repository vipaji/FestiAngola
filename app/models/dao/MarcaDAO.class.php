...
class MarcaDAO {
    ...
    /*public function findByArea($area) {
        $statement = $this->pdo->query("SELECT * FROM marca WHERE area = $area ORDER BY id ASC ");
    ...
    public function UltimasMarcas($orderby = 'nome') {
        $statement = $this->pdo->query('SELECT * FROM marca ORDER BY ' . $orderby . ' limit 5');
