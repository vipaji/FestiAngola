...
Class LogController extends Controller {
    ...
    public function init() {
        ...
        $this->dados['title_page'] = "Log de Operações &bull; Festival Nacional da Canção Patriótica &#8482;";
        $this->dados['page_context'] = "Log de Operações";
        $this->dados['page_icon'] = "fa fa-exchange";
        $this->dados['page_url'] = '/autenticador/log/';
    ...
    public function imprimirPdfAction() {
        try
        {
            $this->dados['entities'] = (new LogDAO())->listarTodas();
