...
$pdf = new DocPdf('P', Method::upperGeneral('Lista geral de veículos'), $utilizador->getNome(), $dataActual->getDataActual(), $direitosAutor);
...
$pdf->imprimirVeiculos($cabecalho, $v_entities);
$pdf->visualizar();
